...
from distill.intake.prompts import get_daily_intake_prompt
...
class IntakeSynthesizer:
    ...
    def synthesize_daily(
        self, context: DailyIntakeContext, memory_context: str = ""
    ) -> str:
        ...
        return self._call_claude(
            system_prompt, user_prompt, f"intake {context.date.isoformat()}"
        )
